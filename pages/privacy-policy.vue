<template>
  <section class="tw-w-full tw-mx-auto tw-px-4 tw-pt-20 tw-pb-14 md:tw-w-[80%]">
    <h1 class="tw-text-xl tw-pb-4">
      <strong>Wapal Privacy Policy </strong>
    </h1>
    <p>
      Wapal and its affiliates (“the platform,” “we,” “our,” and/or “us”) value
    ...
    <p>
      ...
      choose to provide. If you subscribe to our newsletter, then we will
    ...
    <p>
      ...
      online activities over time and across different services. Cookies are
      small text files containing a string of alphanumeric characters. We may
      use both session cookies and persistent cookies. A session cookie
      disappears after you close your browser. A persistent cookie remains after
      you close your browser and may be used by your browser on subsequent
    ...
    <p>
      ...
      request, respond to comments and questions, and otherwise provide customer
      support;
    </p>
    <p>
      (iii) For marketing purposes, such as developing and providing promotional
      and advertising materials that may be useful, relevant, valuable or
      otherwise of interest to you;
    </p>
    <p>
      (iv) To find and prevent fraud, and respond to trust and safety issues
      that may arise;
    </p>
    <p>
      (v) For compliance purposes, including enforcing our Terms of Service or
    ...
    <p>
      ...
      and legal process, such as a court order or subpoena; (ii) respond to your
      requests; or (iii) protect your, our, or others’ rights, property, or
      safety. For the avoidance of doubt, the disclosure of your information may
    ...
    <p>
      ...
      we sell, liquidate, or transfer all or a portion of our business or
      assets.
    </p>
    <p>
    ...
    <p>
      ...
      on these third party services or any information you disclose to these
      third parties. We encourage you to read their privacy policies before
