<template>
  <section class="tw-w-full tw-mx-auto tw-px-4 tw-py-8 md:tw-w-[80%]">
    ...
    <p class="tw-uppercase">
      THE "PLATFORM" IS AVAILABLE ON AN “AS IS” BASIS WITHOUT WARRANTIES OF ANY
    ...
    <p class="tw-uppercase">
      YOU ASSUME ALL RISKS ASSOCIATED WITH USING THE "PLATFORM", AND DIGITAL
      ASSETS AND DECENTRALIZED SYSTEMS GENERALLY, INCLUDING BUT NOT LIMITED TO,
      THAT: (A) DIGITAL ASSETS ARE HIGHLY VOLATILE; (B) STAKING OR DELEGATING
      DIGITAL ASSETS IS INHERENTLY RISKY DUE TO BOTH FEATURES OF SUCH ASSETS AND
      SYSTEMS AND THE POTENTIAL UNAUTHORIZED ACTS OF THIRD PARTIES; (C) YOU MAY
      NOT HAVE READY ACCESS TO ASSETS; AND (D) YOU MAY LOSE SOME OR ALL OF YOUR
      TOKENS OR OTHER ASSETS. YOU AGREE THAT YOU WILL HAVE NO RECOURSE AGAINST
      ANYONE ELSE FOR ANY LOSSES DUE TO THE USE OF THE "PLATFORM". FOR EXAMPLE,
      THESE LOSSES MAY ARISE FROM OR RELATE TO: (I) LOST FUNDS; (II) SERVER
    ...
    <p>
      ...
      authentication, are facilitated by Third-Party Wallet Extensions. By using
      the Platform, you agree that you are bound by the terms of service and
      Privacy Policy for the applicable extensions when using the applicable
      extension.
    </p>
    <p>
    ...
    <p>
      ...
      Platform. If you use the Platform on behalf of another person or entity,
      (a) all references to “you” throughout the Terms will include that person
      or entity, (b) you represent that you are authorized to accept these Terms
    ...
    <p>
      ...
      the Platform, You agree that you are using that Wallet under the terms and
      conditions of the provider of the Wallet. Wallets are not operated by,
      maintained by, or affiliated with Wapal and we do not have custody or
      control over the contents of your Wallet and have no ability to retrieve
      or transfer its contents. We accept no responsibility for, or liability to
      you, in connection with your use of a Wallet and make no representations
      or warranties regarding how the Platform will operate with any specific
      wallet. You are solely responsible for keeping your Wallet secure and you
      should never share your Wallet credentials with anyone. If you discover an
      issue related to your Wallet, please contact your Wallet provider.
    </p>
    <p>
      ...
      connection with Your Account or as a result of Your Account or Wallet
      being compromised. You agree to immediately notify us if you discover or
      otherwise suspect any security issues related to the Platform or Your
      Account. When you use your Wallet with the Platform, you represent to us
      that Your Account and Wallet are owned or controlled exclusively and
    ...
    <p>
      ...
      disassemble, or otherwise attempt to discover the object code, source
      code, or underlying ideas or algorithms of the Platform; (b) modify,
      translate, adapt, or create derivative works of the Platform in any way;
      (c) rent, lease, distribute, sell, resell, assign, or otherwise transfer
      the service or any copy thereof; (d) Use the Service for any purpose other
      than its intended purpose; (e) attempt to disable or circumvent any
      security or other technological measure designed to protect the Service or
      any content available through the Platform; or (f) use the Service for any
      ...
      exceed the scope of the licenses granted in these Terms, then you may be
      subject to prosecution and damages, as well as liability for infringement
      of intellectual property rights, and denial of access to the Service.
    </p>
    <p>
      Without limiting any other provision of these terms, we reserve the right
    ...
    <p>
      If we terminate or suspend your access to the Platform or Service for any
      reason, you are prohibited from attempting to access the Site or Service
    ...
    <p>
      ...
      logos (collectively, the “Wapal Trademarks”) used and displayed on the
      Platform are our registered and/or unregistered trademarks or platform or
      service marks. Any other product and service names located on the Platform
      may be trademarks or service marks owned by third parties (collectively
      with the Wapal Trademarks, the “Trademarks”). Except as otherwise
    ...
    <p>
      ...
      have the ability to launch your NFTs using a Launchpad and mintpages
      developed by Wapal where you can showcase your Creator Content and conduct
      initial sales of NFTs (“Mint Page”). The Creator Content you upload will
      be subject to the license grants and other covenants, representations, and
      warranties set forth in these Terms. Your Launchpad and Mint Page may
      include your project name, logos, images, descriptions, and your Creator
      Content. You should think carefully before Posting any Creator Content to
      your Mint Page. Once you upload Creator Content to the Platform, even if
      you later remove such Creator Content from the Platform, such Creator
      Content may remain available on the Internet and through other sources
      outside of our control in perpetuity. We assume no liability for such
      continued availability of any Creator Content.
    </p>
    <p>
    ...
    <p>
      ...
      External Sites if you have any concerns regarding content located on those
      External Sites. You should take precautions when downloading files from
      all websites to protect your devices from viruses and other destructive
    ...
    <p>
      (i) Use the Platform for any illegal purpose or in violation of any local,
      state, national, or international law;
    </p>
    <p>
      (ii) Harass, threaten, demean, embarrass, bully or otherwise harm any
      other User of the Platform;
    </p>
    <p>
      (iii) Violate, or encourage others to violate, or provide instructions on
    ...
    <p>
      (iv) Interfere with security-related features of the Platform, including
      disabling or circumventing features that prevent or limit use or copying
      of any content.
    </p>
    <p>
      (v) Make unauthorized recordings or screen captures of any content,
      including User Content, transmitted on or through the Platform;
    </p>
    <p>
      (vi) Interfere with the operation of the Platform or any User’s enjoyment
      of the the Platform, including by: (a) uploading or otherwise
      disseminating any virus, adware, spyware, worm, or other malicious code;
      (b) making any unsolicited offer or advertisement to another User of the
      Service; (c) collecting personal information about another User or third
    ...
    <p>
      ...
      or entity, claiming a false affiliation, or accessing any other account on
      the the Platform without permission, or provide any false, inaccurate, or
      misleading information to us
    </p>
    <p>
      (ix) Post User Content that is abusive, bigoted, dangerous, defamatory,
      false, harassing, harmful, infringing, misleading, obscene, offensive,
      pornographic, racist, threatening, unlawful, violent, vulgar, or otherwise
      inappropriate;
    </p>
    <p>
    ...
    <p>
      ...
      (together, the “Wapal Entities”) from and against every claim brought by a
      ...
      connected with: (i) your unauthorized use of, or misuse of, the Platform;
      (ii) your violation of any portion of these Terms, any representation,
      warranty, or agreement referenced in these Terms, or any applicable law or
      regulation; (iii) your violation of any third-party right, including any
      intellectual property right or publicity, confidentiality, other property,
      or privacy right; or (iv) any dispute or issue between you and any third
      ...
      you (without limiting your indemnification obligations with respect to
      that matter), and in that case, you agree to cooperate with our defense of
      those claims.
    </p>
    <p>
    ...
    <p>
      ...
      exclusive understanding and agreement between you and Wapal regarding your
      use of the Platform. You may not assign or transfer these Terms or your
      rights under these Terms, in whole or in part, by operation of law or
      otherwise, without our prior written consent. We may assign these Terms at
      any time without notice or consent. The failure to require performance of
      any provision will not affect our right to require performance at any
      other time after that, nor will a waiver by us of any breach or default of
      ...
      any impact on the interpretation of any provision. Throughout these Terms,
      the use of the word “including” means “including but not limited to.” If
