      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-12">
        <faq-card>
          ...
          <template #answer>
            ...
            Aptos and Sui. Wapal is developed by Mokshya, an open-source
            protocol that builds smart contract solutions for various
            Blockchains.
          </template>
        </faq-card>
        <faq-card>
        ...
        <faq-card>
          ...
          <template #answer>
            ...
            determine it. Eventually, it's the users who have to make a decision
            because even the influencers or anyone who endorse NFT projects
            suggest to do your own research (DYOR).
          </template>
        </faq-card>
        <faq-card>
...
<script lang="ts">
import FaqCard from "@/components/Landing/Faq/FaqCard.vue";
export default {
  components: { FaqCard },
};
</script>
