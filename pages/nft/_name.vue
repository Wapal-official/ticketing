  ...
  async asyncData({ params }: { params: any }) {
    ...
    if (name === "loonies") {
      try {
        ...
        console.log("error fecthing loonies", e);
        collection = {
          id: "loonies",
          name: "loonies",
          ...
          candyMachine: {
            ...
            // public_sale_price: "",
            whitelist_price: "4.2",
            whitelist_sale_time: "2024-06-13T15:00:00.000",
          },
          phases: [
            {
        ...
        if (currentTime < collection.phases[0].mint_time) {
          return { collection };
        } else {
    ...
    try {
      const collection = await getCollectionByUsername(name);
      console.log("coollec", collection);
      if (collection) {
