<template>
    <div class="tw-w-full md:tw-px-8 lg:tw-px-0">
        ...
        <div>
            ...
            <!-- Verification form -->
            <div class="tw-py-4 tw-flex tw-flex-col tw-gap-4 tw-text-wapal-gray tw-w-full lg:tw-w-[60%]">
                <v-stepper v-model="e1" alt-labels flat dense style="background: transparent" class="mx-0 px-0">
                    <v-stepper-items>
                                ...
                                <form @submit.prevent="">
                                    ...
                                    <div
                                        ...
                                        <ValidationProvider
                                            ...
                                            <label class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">Date
                                                of
                                                Birth</label>
                                            <div class="dashboard-text-field-border tw-w-full">
                                                <v-text-field v-model="verification.dob" outlined single-line color="#fff"
                                                    hide-details clearable type="date"
                                    ...
                                    <ValidationProvider
                                        ...
                                        <div class="dashboard-text-field-border tw-w-full">
                                            <v-text-field v-model="verification.occupation" outlined single-line
                                                color="#fff" hide-details clearable class="dashboard-input"></v-text-field>
                                        </div>
                                        <div class="tw-text-red-600">{{ errors[0] }}</div>
                                    </ValidationProvider>
                                    <ValidationProvider
                                    ...
                                    <ValidationProvider
                                        ...
                                        <label
                                            class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">State:</label>
                                        <div class="dashboard-text-field-border tw-w-full">
                                            <v-select v-model="resSelectedStateId" :items="resStateList" outlined
                                                single-line color="#fff" hide-details clearable class="dashboard-input"
                                    ...
                                    <div
                                        ...
                                        <ValidationProvider
                                            ...
                                            <div class="dashboard-text-field-border tw-w-full">
                                                <v-text-field v-model="verification.res_city" outlined single-line
                                                    color="#fff" hide-details clearable aria-placeholder="Eg: Kathmandu"
                                        ...
                                        <ValidationProvider
                                            ...
                                            <label class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">Zip
                                                Code</label>
                                            <div class="dashboard-text-field-border tw-w-full">
                                                <v-text-field v-model="verification.res_code" outlined single-line
                                                    color="#fff" hide-details clearable aria-placeholder="Eg: 00456"
                                                    class="dashboard-input" label="Eg: 00456"></v-text-field>
                                            </div>
                                            <div class="tw-text-red-600">{{ errors[0] }}</div>
                                        </ValidationProvider>
                                    </div>
                                    ...
                                    <ValidationProvider
                                        ...
                                        <label
                                            class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">Country:</label>
                                        <div class="dashboard-text-field-border tw-w-full">
                                            <v-select v-model="selectedCountryCode" :items="countryList" outlined
                                                single-line color="#fff" hide-details clearable class="dashboard-input"
                                                item-value="iso2" item-text="name" @change="onChangeCountry"></v-select>
                                        </div>
                                        <div class="tw-text-red-600">{{ errors[0] }}</div>
                                    </ValidationProvider>
                                    <ValidationProvider
                                    ...
                                    <div
                                        ...
                                        <ValidationProvider
                                            ...
                                            <label
                                                class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">City/Town/Village</label>
                                            <div class="dashboard-text-field-border tw-w-full">
                                                <v-text-field v-model="verification.per_city" outlined single-line
                                                    color="#fff" hide-details clearable class="dashboard-input"
                                        ...
                                        <ValidationProvider
                                            ...
                                            <label class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">Zip
                                                Code</label>
                                            <div class="dashboard-text-field-border tw-w-full">
                                                <v-text-field v-model="verification.per_code" outlined single-line
                                                    color="#fff" hide-details clearable class="dashboard-input"
                        ...
                        <ValidationObserver ref="submitObserver" v-slot="{ submitHandle }">
                                ...
                                <form @click.prevent="">
                                    <div
                                        ...
                                        <div class="tw-flex tw-px-8 tw-flex-col tw-items-start tw-justify-start tw-gap-2">
                                            <label
                                                class="after:tw-content-['*'] after:tw-text-red-600 after:tw-pl-2">Profile
                                                Picture</label>
                                        ...
                                        <ValidationProvider
                                            ...
                                            <div class="dashboard-text-field-border tw-w-full">
                                                <v-file-input v-model="verification.document" multiple
                                                    class="dashboard-input document" background-color="transparent"
                                                    color="#fff" outlined single-line></v-file-input>
                                            </div>
                                            <div class="tw-text-red-600">{{ errors[0] }}</div>
                                        </ValidationProvider>
                                        <div
...
export default {
    ...
    methods: {
        ...
        async submitForm() {
            const isSubmit = await this.$refs.submitObserver.validate();
            if (isSubmit) {
