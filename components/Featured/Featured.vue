    ...
    >
      <div style="position: relative" @click="redirectCollection">
        ...
        <utility-image
          ...
          :alt="collection.name"
          class="clickable-div tw-w-full tw-min-h-[340px] tw-max-h-[338px] md:tw-w-[400px] md:tw-h-[400px] md:tw-max-h-[400px] lg:tw-w-[400px] lg:tw-min-w-[400px] lg:tw-h-[400px] xl:tw-w-[400px] xl:tw-h-[400px] xl:tw-max-h-[400px] tw-object-cover tw-rounded-xl"
          />
        <audio-player
