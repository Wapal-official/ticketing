<template>
  <div
    class="flex flex-col items-start justify-start w-full px-8 py-6 lg:!px-24"
  >
    <nav class="flex flex-row items-center justify-between text-white w-full">
      <NuxtLink to="/" class="text-lg font-medium w-[120px]">
        <img :src="logo" alt="logo" />
      </NuxtLink>
      <div class="hidden lg:flex">
        <landing-menu />
      </div>
      <button @click="toggleLandingMenu" class="flex lg:hidden"></button>
    </nav>
    <div
