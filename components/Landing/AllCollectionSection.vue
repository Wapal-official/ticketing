  ...
  methods: {
    async mapAllCollections() {
      ...
      const collection = {
        ...
        image:
          "https://aggregator-cache.wapal.io/api/cache?l=https://arweave.net/z92BGaOGx-DYVTP_O8W31rAsu3PUO7uAQjzgXIoB2vc/199.png", // Assuming sanctuary is an already cached image
