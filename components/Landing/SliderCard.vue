<template>
  <NuxtLink :to="`/nft/${collection?.username}`"
    ...
    <div
      ...
      <div
        ...
        <div class="tw-pr-4">
          <h6 v-if="collection?.status.sold_out" class="tw-text-xl tw-text-wapal-pink tw-font-normal">
            Soldout
          </h6>
          <div v-else>
            ...
            <count-down :startTime="getStartTime" @countdownComplete="countdownComplete" v-else />
          </div>
        </div>
        <div
