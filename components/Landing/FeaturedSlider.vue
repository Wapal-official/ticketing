<template>
  ...
  >
    ...
    <div
      class="tw-w-4/5 tw-mx-auto tw-flex tw-flex-row tw-items-center tw-justify-center tw-gap-4 tw-mr-10 tw-mr-[40px] tw-mb-3 lg:tw-pt-6 lg:tw-pb-15 2xl:tw-pb-24 1xl:!tw-max-w-[1320px] tw-self-end tw-z-[4] tw-relative"
    >
      <button
