<template>
  ...
  >
    ...
    <div
      class="tw-w-4/5 tw-mx-auto tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-4 tw-pb-6 lg:tw-pt-6 lg:tw-pb-28 1xl:!tw-max-w-[1320px] tw-self-end tw-z-[4] tw-relative"
    >
      <button
