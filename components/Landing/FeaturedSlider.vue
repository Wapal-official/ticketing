<template>
  <section
    class="swiper mySwiper tw-w-full tw-container tw-flex tw-flex-col lg:tw-flex-row"
    ref="swiper"
    v-if="!loading"
  >
    ...
    <div
      class="tw-w-4/5 tw-absolute tw-right-20 tw-bottom-0 tw-justify-end tw-flex tw-flex-row tw-items-center tw-gap-4 tw-mb-3 lg:tw-pt-6 lg:tw-pb-15 xl:tw-pb-24 1xl:!tw-max-w-[1320px] tw-self-end tw-z-[4] lg:tw-gap-2"
    >
      <button
  ...
  async mounted() {
    const collection = {
      ...
      candyMachine: {
        ...
        resource_account:
          "0x39f1338e6b69c3e2f0caa95876e898dbe4c9b272d721626d577554015d033b8",
        candy_id:
          "0x25d440284ca6c1afadb0e83ff1bccacbaa75175551111d8b7cb5d2854e708f0",
      },
      status: {
        sold_out: false,
      },
