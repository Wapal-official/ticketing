<template>
  ...
  >
    ...
    <div
      class="tw-w-full tw-min-h-full tw-border tw-border-transparent tw-px-4 tw-py-16 tw-flex tw-flex-col tw-items-center tw-justify-center tw-gap-4 md:tw-border-wapal-pink md:tw-py-8"
    >
      <img
      ...
      <div class="tw-h-[2px] tw-w-full tw-bg-wapal-pink"></div>
      <h4 class="tw-text-xl tw-text-wapal-pink tw-font-normal">Properties</h4>
      <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 tw-gap-4 tw-w-full">
        <div
          class="tw-rounded-md tw-bg-wapal-pink/25 tw-px-2 tw-py-2 tw-flex tw-flex-col tw-items-start tw-justify-start tw-gap-1 tw-text-sm"
