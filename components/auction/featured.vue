<template>
  <div
    class="tw-w-[90%] tw-container tw-mx-auto tw-py-16 tw-transition-all tw-duration-200 tw-ease-linear md:tw-px-0 md:tw-w-4/5 lg:tw-pt-16 lg:tw-pb-6 2xl:!tw-max-w-[1152px]"
  >
    <div
